...
int main() {
    /* Not sure what the book is referring to -- pushing back EOF with GCC
     * seems to work fine.  I'm thinking that their C implementation has
     * char as unsigned by default? */
    ungetch(EOF);
